...
const fetchRecordsByCategory = async (
  ...
  try {
    ...
    const fetchString: string = `${BASE_URL}/organization?filterByFormula=FIND(%22${category}%22%2Corg_categories)&fields%5B%5D=location_latitude&fields%5B%5D=location_longitude&fields%5B%5D=locations_city&fields%5B%5D=org_categories&fields%5B%5D=org_categories_spanish&fields%5B%5D=org_customers_served&fields%5B%5D=org_customers_served_spanish&fields%5B%5D=org_languages_spoken&fields%5B%5D=org_languages_spoken_spanish&fields%5B%5D=org_name${append}&fields%5B%5D=org_tags${append}&fields%5B%5D=location_services${append}&sort%5B0%5D%5Bfield%5D=org_name${append}`
